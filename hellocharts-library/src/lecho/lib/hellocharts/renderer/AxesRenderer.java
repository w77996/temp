...
public class AxesRenderer {
    ...
    private Paint[] xAxisPaintTab = new Paint[]{new Paint(), new Paint(), new Paint(), new Paint()};
    private Paint[] yAxisPaintTab = new Paint[]{new Paint(), new Paint(), new Paint(), new Paint()};
    ...
    private float[] xAxisLineTab = new float[4];
    private float[] yAxisLineTab = new float[4];
    ...
    public AxesRenderer(Context context, Chart chart) {
        ...
        for (int position = 0; position < 4; ++position) {
            ...
            xAxisPaintTab[position].setStyle(Paint.Style.STROKE);
            xAxisPaintTab[position].setAntiAlias(true);

            yAxisPaintTab[position].setStyle(Paint.Style.STROKE);
            yAxisPaintTab[position].setAntiAlias(true);
    ...
    private void initAxisPaints(Axis axis, int position) {
        ...
        xAxisPaintTab[position].setColor(axis.getxAxisColor());
        yAxisPaintTab[position].setColor(axis.getyAxisColor());
...
//            canvas.drawLine(separationX1, separationY1, separationX2, separationY2, labelPaintTab[position]);
            ...
            canvas.drawLine(separationX1, separationY1, separationX2, separationY2, xAxisPaintTab[position]);
            canvas.drawLine(separationX1, separationY1, separationX2, separationY2, yAxisPaintTab[position]);
        }
...
//            canvas.drawLines(linesDrawBufferTab[position], 0, valueToDrawIndex * 4, xAxisPaintTab[position]);
//            canvas.drawLines(linesDrawBufferTab[position], 0, valueToDrawIndex * 4, yAxisPaintTab[position]);
        }
    }
