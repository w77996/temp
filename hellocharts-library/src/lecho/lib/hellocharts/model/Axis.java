...
public class Axis {
    ...
    private int xAxisColor = Color.TRANSPARENT;

    private int yAxisColor = Color.TRANSPARENT;
    /**
    ...
    public Axis(Axis axis) {
        ...
        this.xAxisColor = axis.xAxisColor;
        this.yAxisColor = axis.yAxisColor;
    ...
    public Axis setXAxisColor(int xAxisColor) {
    ...
    public Axis setYAxisColor(int yAxisColor) {
