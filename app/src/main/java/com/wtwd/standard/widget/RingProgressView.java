        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                case R.styleable.RingProgressView_start_circle_color:
                    mStartCircleColor = a.getColor(attr, ContextCompat.getColor(context, R.color.color_white));
                    break;

                case R.styleable.RingProgressView_end_circle_color:
                    mEndCircleColor = a.getColor(attr, ContextCompat.getColor(context, R.color.color_white));
                    break;

                case R.styleable.RingProgressView_ring_color:
                    mRingCircleColor = a.getColor(attr, ContextCompat.getColor(context, R.color.color_white));
                    break;

                case R.styleable.RingProgressView_progress_color:
                    mProgressColor = a.getColor(attr, ContextCompat.getColor(context, R.color.color_white));
                    break;
